////////////////////////////////////////////////////////////////////////////////
// _Internal/_WinPCFileSystemPathComponent.h (Leggiero/Modules - FileSystem)
//
// WinPC Platform's File System Path Component
////////////////////////////////////////////////////////////////////////////////

#ifndef __LM_FILESYSTEM___INTERNAL__WINPC_FILE_SYSTEM_PATH_COMPONENT_H
#define __LM_FILESYSTEM___INTERNAL__WINPC_FILE_SYSTEM_PATH_COMPONENT_H
...
namespace Leggiero
{
	namespace FileSystem
	{
		...
		class WinPCFileSystemPathComponent
			: public FileSystemPathComponent
		{
		public:
			WinPCFileSystemPathComponent();
			virtual ~WinPCFileSystemPathComponent();
